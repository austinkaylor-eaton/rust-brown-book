use art_lib::kinds::PrimaryColor;
use art_lib::utils::mix;
...
fn red_and_yellow_make_orange() {
    ...
    assert_eq!(result, Some(art_lib::kinds::SecondaryColor::Orange));
}
...
fn red_and_blue_make_purple() {
    ...
    assert_eq!(result, Some(art_lib::kinds::SecondaryColor::Purple));
}
...
fn yellow_and_blue_make_green() {
    ...
    assert_eq!(result, Some(art_lib::kinds::SecondaryColor::Green));
}
